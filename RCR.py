...
class compression:
                                                ...
                                                while block<long:
                                                                            ...
                                                                            if Find!=0:
                                                                                ...
                                                                                if len(sda4)==126:
                                                                                    ...
                                                                                    Find=1
                                                                                    find_matches_1=int(str_find_tree_maches.find("0000", start, end))
                                                                            if find_matches_1==-1 and sub_info4==find_matches_1: 
    ...
    Find=0 
                                                                            if find_matches_2==-1 and sub_info4==find_matches_2:
                                                                                             Find=0    
                                                                            find_matches_3=int(str_find_tree_maches.find("1010", start, end))
                                                                           if find_matches_3==-1 and sub_info4==find_matches_3:
                                                                                                     Find=0   
        
                                                                                    find_matches_4=int(str_find_tree_maches.find("1111", start, end))
                                                                           if find_matches_4==-1 and sub_info4==find_matches_4
                                                                                             Find=0
                                                                                             
                                                                                                                                                                                                                                                  
                                                                                    
                                                                                    
                                                                                    if find_matches_5!=0 and Find!=0:
